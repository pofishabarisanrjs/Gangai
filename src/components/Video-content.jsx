...
function Video() {
  ...
  return (
    <Container className="video py-5">
      <Row className="align-items-center justify-content-center">
        {/* Left Content */}
        <Col xs={12} md={6} className="animate__animated animate__fadeInLeft text-center text-md-start">
        <Container>
        <div className="headingcss fontdesign pb-4">Success Story</div>
          <p className="fontdesign">
            ...
            Length and appearance do not determine whether a section in a paper is a paragraph. For instance, in some styles of writing, particularly journalistic styles.
          </p>
        </Container>
              ...
              <Col xs={12} sm={6} key={index} className="mb-4">
                <Card className="border-0 animate__animated animate__zoomIn h-100 p-3 card-hover">
                  ...
                  <Card.Body className="text-center text-md-start">
                    <Card.Title className="fontdesign fw-bold">{item.title}</Card.Title>
        ...
        {/* Right Content */}
        <Col xs={12} md={6} className="animate__animated animate__fadeInRight">
